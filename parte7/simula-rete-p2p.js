...
import { Wallet } from './wallet.js';//Parte6
...
//Parte6 - Inizio
const wallet = new Wallet(myPeerId.toString('hex'));
...
(async () => {
    ...
    new HttpServer().run( '80' + port.toString().slice(-2),myBlockchain, wallet );//parte7
